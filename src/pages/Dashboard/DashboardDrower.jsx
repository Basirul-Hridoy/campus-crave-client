    ...
    return (
        <div className="flex">
            ...
            <div onClick={() => setShowDashboardSidebar(pre => !pre)} className='z-[100] absolute top-5 right-5 text-accent text-3xl cursor-pointer md:hidden '>
                {showDashboardSidebar ? <IoIosCloseCircle /> : <BiSolidDashboard />}
            </div>

            {/*//* ================================ Mobile version ===================================*/}
            {/*//* ================================ Mobile version ===================================*/}
            <div className={`z-50 origin-left block md:hidden w-full bg-dashboard-primary min-h-screen absolute duration-700 ${showDashboardSidebar ? 'scale-x-100 w-full' : 'scale-x-0'}`}>
            ...
            {/*//* Dashboard outlate*/}
            <div className="flex-1 bg-[#151C2C] text-accent md:p-10 p-2 min-h-screen pt-16 md:pt-12 overflow-x-auto">
                <Outlet />
            </div>
        </div>
    );
